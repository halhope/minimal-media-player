...
Download and unzip [Beaver Receiver.zip](/Windows/Application/Beaver%20Receiver_Windows.zip) and put the folder somewhere handy. Find the application inside to launch Beaver Receiver. Once running, it can be pinned to the Taskbar or added to Startup programs, etc.
